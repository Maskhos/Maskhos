				...
				<form enctype="multipart/form-data" class="form-horizontal maskhos-form" role="form" method="POST" action="{{ url('/blog/create') }}">
					...
					<fieldset>
						...
						<div class="form-group{{ $errors->has('postitle') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<div class="maskhos-pro-div"><input type="text" class="form-control maskhos-z-input" name="postitle" value="{{ old('postitle') }}"></div>
						...
						<div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<div class="maskhos-pro-div"><select class="form-control maskhos-z-input-select" name="category">
						...
						<div class="form-group{{ $errors->has('posshortdesc') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<div class="maskhos-pro-div"><input type="text" class="form-control maskhos-z-input" name="posshortdesc" value="{{ old('posshortdesc') }}"></input></div>
						...
						<div class="form-group{{ $errors->has('poscontent') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<div class="maskhos-pro-div"><textarea class="form-control maskhos-z-input" name="poscontent" value="{{ old('poscontent') }}"></textarea></div>
						...
						<div class="form-group{{ $errors->has('posphoto') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<div class="maskhos-pro-div"><input type="file" class="form-control maskhos-z-input" name="posphoto" value="{{ old('posphoto') }}"></input></div>
